    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 14, color: "#888", fontWeight: 400, marginLeft: 8 }}>
          {userId && <>Utilisateur : <strong>{userId}</strong></>}
        </span>
      </h2>
      <div style={{ overflowX: "auto" }}>
        ...
        >
          <thead>
            <tr>
              <th scope="col" style={{ borderBottom: "2px solid #ffe082", textAlign: "left", paddingBottom: 6 }}>Date</th>
              <th scope="col" style={{ borderBottom: "2px solid #ffe082", textAlign: "left", paddingBottom: 6 }}>Description</th>
              <th scope="col" style={{ borderBottom: "2px solid #ffe082", textAlign: "right", paddingBottom: 6 }}>Montant</th>
            </tr>
          </thead>
          <tbody>
            {sortedTx.length === 0 && (
            ...
            {sortedTx.map(tx => (
              <tr
                ...
                style={{
                  background: tx.amount > 0 ? "#f1f8e9" : tx.amount < 0 ? "#ffebee" : "#fff",
              ...
              >
                ...
                <td style={{ padding: "8px 0", fontSize: 15 }}>{tx.description}</td>
                <td style={{
                  textAlign: "right",
