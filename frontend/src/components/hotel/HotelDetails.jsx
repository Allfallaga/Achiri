...
const defaultHotel = {
  ...
  gallery: [
    "/assets/hotels/inclusif1.jpg",
    "/assets/hotels/inclusif2.jpg"
  ],
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 28 }}>
        ...
        <div style={{ flex: "2 1 320px", minWidth: 220 }}>
          ...
          <div style={{ fontSize: 15, marginBottom: 8 }}>
            <span role="img" aria-label="téléphone">📞</span> <a href={`tel:${hotel.phone}`} style={{ color: "#1976d2", textDecoration: "underline" }}>{hotel.phone}</a>
          </div>
          <div style={{ fontSize: 15, marginBottom: 8 }}>
            <span role="img" aria-label="email">✉️</span> <a href={`mailto:${hotel.email}`} style={{ color: "#1976d2", textDecoration: "underline" }}>{hotel.email}</a>
          </div>
          <div style={{ fontSize: 15, marginBottom: 14 }}>
            <span role="img" aria-label="site web">🌐</span> <a href={hotel.website} target="_blank" rel="noopener noreferrer" style={{ color: "#1976d2", textDecoration: "underline" }}>{hotel.website.replace(/^https?:\/\//, "")}</a>
          </div>
          <button
            type="button"
            onClick={onBook}
