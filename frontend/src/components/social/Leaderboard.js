  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Classement des utilisateurs Achiri : points, badges, rôles, avatars, filtres, accessibilité, sécurité, responsive, SEO, design avancé." />
      </Helmet>
      <header style={{ marginBottom: 18 }}>
        ...
        <nav aria-label="Filtres du classement" style={{ marginTop: 12, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          {filters.map(f => (
            <button
              key={f.key}
