  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Participez, créez ou gérez vos classes virtuelles sur Achiri. Plateforme IA inclusive pour tous : accessibilité, éducation, collaboration." />
        <html lang="fr" />
      </Helmet>
