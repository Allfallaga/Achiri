...
/**
 * UserList – Achiri
 * Liste des utilisateurs connectés à la room : rôles, mute, main levée, badges, points, wallet, actions owner/admin, statut, animation.
 * - UX avancée, accessibilité, sécurité, responsive, SEO, design Achiri.
 * - Fonctionnalités : gestion rôles, mute, main levée, badges, points, wallet, actions owner/admin, statut, animation, dark mode ready.
 * - Prêt pour extensions futures (badges custom, analytics, favoris, etc).
 *
 * Props :
          ...
          >
            ...
            >
              ...
              {role === "owner" && (
                <span
                  title="Owner"
                  style={{ marginLeft: 4, fontSize: 15, color: "#1976d2" }}
                >
                  👑
                </span>
              )}
              {role === "admin" && (
                <span
                  title="Admin"
                  style={{ marginLeft: 4, fontSize: 15, color: "#43a047" }}
                >
                  🛡️
                </span>
              )}
              {isMuted && (
                <span
                  title="Muet"
                  style={{ marginLeft: 4, fontSize: 15, color: "#b71c1c" }}
                >
                  🔇
                </span>
              )}
              ...
              {userPoints !== undefined && (
                <span
                  style={{ marginLeft: 8, color: "#1976d2", fontWeight: 600 }}
                >
                  {userPoints} pts
                </span>
              )}
...
/**
 * Documentation :
 * - UserList : liste utilisateurs, rôles, mute, main levée, badges, points, wallet, actions owner/admin, statut, animation.
