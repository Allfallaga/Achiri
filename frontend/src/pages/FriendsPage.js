  ...
  return (
    <main
      style={{
        maxWidth: 480,
        margin: '2rem auto',
        background: darkMode ? 'linear-gradient(120deg, #181f2a 60%, #1976d2 100%)' : '#fff',
        borderRadius: 16,
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Gérez votre liste d'amis sur Achiri : ajout, suppression, recherche, avatars. Plateforme IA inclusive, accessible et sécurisée." />
        <html lang="fr" />
      </Helmet>
