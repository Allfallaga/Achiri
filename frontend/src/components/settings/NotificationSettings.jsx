...
import { FaBell, FaEnvelope, FaVolumeUp, FaSave, FaInfoCircle } from "react-icons/fa";
...
const NotificationSettings = ({ userId }) => {
  ...
  return (
    ...
    >
      <h2 className="settings-panel-title flex items-center"> {/* Utilisation de la classe du CSS */}
        <FaBell style={{ marginRight: 8 }} /> Notifications
      </h2>

      {/* Section Push */}
      <div className="setting-item"> {/* Utilisation de la classe du CSS */}
        <div className="setting-item-label"> {/* Utilisation de la classe du CSS */}
          <strong>Notifications push</strong>
          <span>Recevoir des alertes directement sur votre appareil.</span>
        </div>
        <div className="setting-item-control"> {/* Utilisation de la classe du CSS */}
          <label className="toggle-switch" aria-label="Activer ou désactiver les notifications push"> {/* Utilisation de la classe du CSS */}
            <input
              type="checkbox"
            ...
            />
            <span className="slider"></span> {/* Utilisation de la classe du CSS */}
          </label>
        </div>
      </div>
      ...
      <div className="setting-item"> {/* Utilisation de la classe du CSS */}
        ...
        <div className="setting-item-control"> {/* Utilisation de la classe du CSS */}
          <label className="toggle-switch" aria-label="Activer ou désactiver les notifications par email"> {/* Utilisation de la classe du CSS */}
            <input
              type="checkbox"
      ...
      <div className="setting-item"> {/* Utilisation de la classe du CSS */}
        ...
        <div className="setting-item-control"> {/* Utilisation de la classe du CSS */}
          <label className="toggle-switch" aria-label="Activer ou désactiver les notifications sonores"> {/* Utilisation de la classe du CSS */}
            <input
              type="checkbox"
      ...
      {/* Actions */}
      <div className="settings-actions"> {/* Utilisation de la classe du CSS */}
        <button
      ...
      {message && (
        <div
          ...
          aria-live="polite"
          style={{ marginTop: 'var(--spacing-md)', textAlign: 'center', color: 'var(--color-success-main)' }}
        >
          {message}
        </div>
      )}
      ...
      <div className="settings-tip" style={{
        ...
        <span>Astuce : Activez les notifications push pour ne rien manquer sur Achiri.</span>
      </div>
    </motion.div>
  );
};
