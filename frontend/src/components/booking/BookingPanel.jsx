...
/**
 * BookingPanel – Achiri
 * Panneau de réservation universel : accessibilité, sécurité, mobile/web, design avancé.
 * - UX avancée, accessibilité, sécurité, responsive, SEO friendly, design Achiri.
 * - Fonctionnalités : formulaire de réservation, choix de date/heure, options accessibilité, feedback utilisateur.
 * - Prêt pour extensions futures (paiement, analytics, dark mode, etc).
 *
 * Props :
 *   onBook?: function (callback lors de la réservation)
 */
...
const BookingPanel = ({ onBook }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      onBook && onBook({ name, date, time, options });
  ...
  return (
    <section
      ...
      aria-label="Panneau de réservation Achiri"
      tabIndex={0}
    >
      <h2
        style={{
        ...
        tabIndex={0}
        aria-label="Réservation accessible"
      >
      ...
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        {feedback && (
          <div
            style={{
              color: feedback.includes("confirmée") ? "#388e3c" : "#b71c1c",
              fontWeight: 500,
              marginTop: 12,
            }}
            aria-live="polite"
...
/**
 * Documentation :
 * - Panneau de réservation accessible : formulaire, options, feedback, accessibilité.
