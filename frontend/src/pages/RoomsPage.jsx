  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Liste et gestion des salles de visioconférence sur Achiri. Plateforme IA inclusive, accessible et sécurisée."
        />
        <html lang="fr" />
      </Helmet>
      <header
      ...
      >
        Retrouvez ici toutes les salles de visioconférence disponibles ou
        créez-en une nouvelle.
      </p>
      {/* Affichage de la liste des rooms */}
      <section
        aria-label="Rooms disponibles"
