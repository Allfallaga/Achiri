...
const defaultTransports = [
  ...
  },
  {
    ...
    description: "Taxi sur réservation, accès fauteuil, accompagnement personnalisé.",
        ...
        {filteredTransports.map(transport => (
          <article
            ...
            style={{
              ...
              border: selected === transport.id ? "2px solid #1976d2" : "1px solid #e3f2fd",
              borderRadius: 14,
            ...
            onKeyDown={e => (e.key === "Enter" || e.key === " ") && handleSelect(transport)}
            role="button"
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <div style={{ fontWeight: 700, fontSize: 18, color: "#1976d2" }}>{transport.name}</div>
            <div style={{ color: "#555", fontSize: 15, marginBottom: 4 }}>{transport.type}</div>
            ...
            <button
              type="button"
              onClick={e => { e.stopPropagation(); handleSelect(transport); }}
