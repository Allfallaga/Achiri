  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Analyse intelligente et recommandations personnalisées pour votre profil sur Achiri. Plateforme IA inclusive, accessible et sécurisée." />
        <html lang="fr" />
      </Helmet>
      ...
      >
        <h2 id="outils-analyse-profil" style={{ color: darkMode ? "#ffd600" : "#333", fontSize: "1.25em", fontWeight: 600 }}>
          Outils disponibles :
        </h2>
