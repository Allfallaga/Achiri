  ...
  return (
    <main>
      <Helmet>
        ...
        <meta name="description" content="Liste des salons vidéo Achiri : accès rapide, design avancé, accessibilité, sécurité, mobile/web, SEO optimisé." />
      </Helmet>
      <Typography
        variant="h4"
        sx={{
      ...
      >
        {loading ? (
          <div
            ...
            aria-live="polite"
          >
            <CircularProgress color="primary" size={40} aria-label="Chargement des salons" />
      ...
      >
        Tous les salons Achiri sont sécurisés, accessibles et compatibles mobile/web.<br />
