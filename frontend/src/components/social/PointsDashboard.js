  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Tableau de bord des points Achiri : solde, historique, stats, accessibilité, sécurité, responsive, SEO, design avancé."
        />
      </Helmet>
      <h2
        ref={titleRef}
      ...
      <h3 style={{ margin: "1.5em 0 0.5em 0", color: "#1976d2", fontSize: 19 }}>
        Historique
      </h3>
      <div
        style={{
          ...
          {history.map((h, i) => (
            <li
              ...
              style={{
                ...
                padding: "0.5em 0",
                borderBottom:
                  i < history.length - 1 ? "1px solid #e0e0e0" : "none",
              }}
            >
