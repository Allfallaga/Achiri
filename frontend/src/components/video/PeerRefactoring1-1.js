...
function PeerRefactoring(props) {
  ...
  useEffect(() => {
    socket.current = io(process.env.REACT_APP_PEERSERVER_ADDR_COMP || "185.245.96.81:445", { transports: ['websocket'] });
  ...
  return (
    <Box sx={{ maxWidth: 900, margin: "0 auto", p: 2 }}>
      <Helmet>
        ...
        <meta name="description" content="Démo peer-to-peer Achiri : mediasoup, accessibilité, sécurité, design avancé, mobile/web." />
      </Helmet>
      ...
      <Typography variant="body2" sx={{ color: "#888", mt: 2 }}>
        Cette démo peer-to-peer Achiri utilise mediasoup pour une connexion directe, accessible et sécurisée.<br />
