 ...
 * - Message clair, navigation rapide, dark mode, mobile first, SEO ready.
 * - Prêt pour extensions futures (recherche, feedback, support, IA, etc).
 * - Accessibilité universelle, feedback utilisateur, branding Achiri.
 */
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
        <h1 style={{ fontSize: '3rem', color: darkMode ? "#ffd600" : "#1976d2", margin: 0, flex: 1 }}>
          404
        </h1>
        <button
          type="button"
      ...
      <h2 style={{ color: darkMode ? "#bbb" : "#888", marginTop: 8, marginBottom: 16 }}>Page non trouvée</h2>
      <p style={{ fontSize: '1.1em', color: darkMode ? "#e3f2fd" : "#444", marginBottom: 32 }}>
 ...
 * - Design avancé, branding Achiri, mobile first, prêt pour extensions futures (recherche, feedback, support, IA, etc).
 */