  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Votre tableau de bord Achiri : portefeuille, notifications, classes virtuelles, accessibilité, analyse IA. Plateforme IA inclusive, accessible et sécurisée." />
        <html lang="fr" />
      </Helmet>
