  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Gérez votre portefeuille, consultez votre solde et l'historique de vos transactions sur Achiri. Plateforme IA inclusive, accessible et sécurisée." />
        <html lang="fr" />
      </Helmet>
