...
import MusicLibrary from "../components/music/MusicLibrary.js";
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Écoutez, partagez et découvrez de la musique avec la communauté Achiri. Plateforme IA inclusive, accessible et sécurisée."
        />
        <html lang="fr" />
      </Helmet>
      <header
